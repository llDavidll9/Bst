Code used in the paper "A Leptokurtic-form Birnbaum-Saunders
distribution with applications to finance". The data "dadossharpe.txt" correspond to monthly returns of shares from the Chilean Stock Market. The data
